...
namespace Handy.Lib
{
    public class DeliveryPreparationBase
    {
        ...
        public static bool GetWRISList()
        {
            ...
            if (CommonFunctions.IsConnected())
            {
                ...
                CommonFunctions.WRISTable = CommonFunctions.GetData(string.Format(CommonQueryStrings.StoredProc.spHandyGetProductIssueList, CommonFunctions.BarcodeWHReqControlNo));
        ...
        public static void GetRRListWithReservedProjNo()
        {
            ...
            CommonFunctions.RRListWithUnmatchProjCode = CommonFunctions.GetData(string.Format(CommonQueryStrings.StoredProc.spHandyGetProductIssueListWithProjNo, CommonFunctions.BarcodeWHReqControlNo));
        }
        ...
        public static void IssueItem()
        {
            try
            {
                CommonFunctions.SendingThread(CommonEnum.Function.DeliveryPreparation);
            }
            catch (Exception ex)
            {
        ...
        public static bool GetWRISSplitList()
        {
            ...
            CommonFunctions.WRISTableSplitList = CommonFunctions.GetData(string.Format(CommonQueryStrings.StoredProc.spHandyGetProductIssueList, CommonFunctions.BarcodeWHReqControlNo));
